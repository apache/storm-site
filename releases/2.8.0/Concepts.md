...
* [TopologyBuilder](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/topology/TopologyBuilder.html): use this class to construct topologies in Java
...
Every stream is given an id when declared. Since single-stream spouts and bolts are so common, [OutputFieldsDeclarer](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/topology/OutputFieldsDeclarer.html) has convenience methods for declaring a single stream without specifying an id. In this case, the stream is given the default id of "default".


**Resources:**

* [Tuple](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/tuple/Tuple.html): streams are composed of tuples
* [OutputFieldsDeclarer](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/topology/OutputFieldsDeclarer.html): used to declare streams and their schemas
...
There are eight built-in stream groupings in Storm, and you can implement a custom stream grouping by implementing the [CustomStreamGrouping](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/grouping/CustomStreamGrouping.html) interface:
...
* [TopologyBuilder](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/topology/TopologyBuilder.html): use this class to define topologies
* [InputDeclarer](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/topology/InputDeclarer.html): this object is returned whenever `setBolt` is called on `TopologyBuilder` and is used for declaring a bolt's input streams and how those streams should be grouped
...
* [Config.TOPOLOGY_WORKERS](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.0/org/apache/storm/Config.html#TOPOLOGY_WORKERS): this config sets the number of workers to allocate for executing the topology
