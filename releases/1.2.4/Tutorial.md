...
The object containing the processing logic implements the [IRichSpout](https://javadoc.io/doc/org.apache.storm/storm-client/1.2.4/org/apache/storm/topology/IRichSpout.html) interface for spouts and the [IRichBolt](https://javadoc.io/doc/org.apache.storm/storm-client/1.2.4/org/apache/storm/topology/IRichBolt.html) interface for bolts.
...
There's many other configurations you can set for the topology. The various configurations are detailed on [the Javadoc for Config](https://javadoc.io/doc/org.apache.storm/storm-client/1.2.4/org/apache/storm/Config.html).
