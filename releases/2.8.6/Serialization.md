...
Storm provides helpers for registering serializers in a topology config. The [Config](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.6/org/apache/storm/Config.html) class has a method called `registerSerialization` that takes in a registration to add to the config.
