...
For the assumptions, trust boundaries, and scope of what Storm considers a security vulnerability, see the [Apache Storm Security Model](/security-model.html). Reading it first is recommended before reporting security issues.
...
Storm provides the Access Control List for the DRPC Authorizer.Users can see [org.apache.storm.security.auth.authorizer.DRPCSimpleACLAuthorizer](https://javadoc.io/doc/org.apache.storm/storm-client/2.8.6/org/apache/storm/security/auth/authorizer/DRPCSimpleACLAuthorizer.html) for more details.
