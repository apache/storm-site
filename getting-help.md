...
If you are committers and/or PMC members, or contributors looking to follow and participate in the development of Storm, then you would want to also subscribe to [issues@storm.apache.org](mailto:issues@storm.apache.org) in addition to [dev@storm.apache.org](mailto:dev@storm.apache.org).
