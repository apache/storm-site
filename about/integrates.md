...
Apache Storm integrates with any queueing system and any database system. Apache Storm's [spout](/releases/current/javadocs/org/apache/storm/spout/ISpout.html) abstraction makes it easy to integrate a new queuing system. 
